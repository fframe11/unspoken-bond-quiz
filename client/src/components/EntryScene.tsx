    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8" style={{ backgroundColor: "#fdfbf7" }}>
      ...
      <div className="phone-screen relative">
        ...
        <div className="scene-box">
          คุณมองเห็นเธอจากมุมมองของตัวเอง — ตอนนี้ เรามาเข้าใจใจของเธอผ่านการตัดสินใจของคุณ
        </div>
        ...
        {/* Hint */}
        <p style={{ fontSize: "12px", fontStyle: "italic", color: "#555", marginTop: "15px", textAlign: "center" }}>
